...
38 beads: 1 root, 7 sub-epics, 30 tasks. Hierarchy is `bd update <id> --parent`;
...
|---|---|---|---|
| `syl-013.1` | Phase 1: the reach — the browser, her profile, the allowlist below her | 0 | 8 |
...
| T007 | `syl-013.1.7` | Browser-generic verbs, never site-semantic | `backend/src/tools/schemas.ts` |
...
| **Total** | **30 tasks + 7 sub-epics + 1 root = 38** | | |

## Dependency graph

```
syl-013.1.3 ──> .1.4 ──> .1.5 ──> .1.6 ──> .1.7
syl-013.1.1 ──────────────^                 |
syl-013.1.2 ──> .1.8                        |
