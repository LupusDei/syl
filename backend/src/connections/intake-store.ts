 ...
 *
 * ## The schema is a migration
 *
 * `migrations/0008_intake.sql`, applied by `openDatabase` like every other.
 * It used to be a string constant in this file, executed only by intake's own
 * test helper — so the whole suite passed and the first call against the real
 * database threw `no such table` (`syl-1o7`).
 */
